...
export function Search() {
  ...
  const mockResults = {
    ...
    jobs: [
      { id: 7, type: 'job', title: 'Downtown Office Complex', location: 'Seattle, WA', status: 'Installation' },
      { id: 8, type: 'job', title: 'Retail Shopping Center', location: 'Portland, OR', status: 'Pending' },
      { id: 9, type: 'job', title: 'Tech Campus Building A', location: 'Bellevue, WA', status: 'Complete' },
    ]
  };
